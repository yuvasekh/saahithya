...
const headers = {
  ...
  return await axios.post(`${rootUrl}api/uploadfile`, formData,{headers: {
    ...headers,
    'Content-Type': 'multipart/form-data', // Use this header for FormData
  },});
}
...
export async function getcontestresults() {
  ...
  return await axios
    .get(`${rootUrl}api/getcontestresult`)
    .then((response) => {
      console.log(response.data);
      return response.data;
    })
